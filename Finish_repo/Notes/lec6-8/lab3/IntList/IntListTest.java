...
public class IntListTest {
    ...
    public void testReverse(){
        System.out.println("First Test : IntList with real elements...");
        ...
        System.out.println("Third Test : Destructive reverse...");
        IntList input3 = IntList.of(0,1,2,3);
        IntList actual3 = IntList.reverse(input3);
        assertNotEquals(input3,actual3);
