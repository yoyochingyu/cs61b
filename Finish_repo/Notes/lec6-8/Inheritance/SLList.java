/**
 * 1. <前><後>兩個<>替換的generic type應該要相同</>，<前>代表在這個class，<後>代表套用到interface
 * */
public class SLList<Blorp> implements List61B<Blorp>  {
    ...
    @Override
    public void print(){
        System.out.println("This overrides the implementation!");
        /**不可以直接用sentinel移動，sentinel會被改到*/
        /**sentinel指向sentinel node(是空的)*/
